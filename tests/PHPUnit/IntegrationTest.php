...
final class IntegrationTest extends TestCase
{
    ...
    public static function instantiate_shape_object_dataProvider(): Generator
    {
        ...
        yield 'from array without optionals' => ['value' => ['stringBased' => 'Some value', 'stringOrNull' => null, 'givenNamesOrNull' => null], 'className' => Fixture\ShapeWithOptionalTypes::class, 'expectedResult' => '{"stringBased":"Some value","stringOrNull":null,"givenNamesOrNull":null}'];
        yield 'from array with optionals' => ['value' => ['stringBased' => 'Some value', 'stringOrNull' => 'some string', 'givenNamesOrNull' => ['John', 'Jane'], 'optionalString' => 'optionalString value', 'optionalStringBased' => 'oSB value', 'optionalInt' => 42, 'optionalBool' => true], 'className' => Fixture\ShapeWithOptionalTypes::class, 'expectedResult' => '{"stringBased":"Some value","stringOrNull":"some string","givenNamesOrNull":["John","Jane"],"optionalStringBased":"oSB value","optionalInt":42,"optionalBool":true,"optionalString":"optionalString value"}'];
        yield 'from array with optionals and coercion' => ['value' => ['stringBased' => 'Some value', 'stringOrNull' => null, 'givenNamesOrNull' => null, 'optionalString' => new class {
            public function __toString()
            {
                return 'optionalString value';
            }
        }, 'optionalStringBased' => 'oSB value', 'optionalInt' => '123', 'optionalBool' => 1], 'className' => Fixture\ShapeWithOptionalTypes::class, 'expectedResult' => '{"stringBased":"Some value","stringOrNull":null,"givenNamesOrNull":null,"optionalStringBased":"oSB value","optionalInt":123,"optionalBool":true,"optionalString":"optionalString value"}'];
        yield 'from array with optionals and coercion 2' => ['value' => ['stringBased' => 'Some value', 'stringOrNull' => 'some string', 'givenNamesOrNull' => instantiate(Fixture\GivenNames::class, ['Jane', 'John']), 'optionalString' => new class {
            public function __toString()
            {
                return 'optionalString value';
            }
        }, 'optionalStringBased' => 'oSB value', 'optionalInt' => 55.0, 'optionalBool' => '0'], 'className' => Fixture\ShapeWithOptionalTypes::class, 'expectedResult' => '{"stringBased":"Some value","stringOrNull":"some string","givenNamesOrNull":["Jane","John"],"optionalStringBased":"oSB value","optionalInt":55,"optionalBool":false,"optionalString":"optionalString value"}'];
        yield 'from array with optionals and coercion 3' => ['value' => ['stringBased' => 'Some value', 'stringOrNull' => 'some string', 'givenNamesOrNull' => instantiate(Fixture\GivenNames::class, ['Jane', 'John']), 'optionalString' => null, 'optionalStringBased' => 'oSB value', 'optionalInt' => 55.0, 'optionalBool' => 'false', 'boolWithDefault' => 'true'], 'className' => Fixture\ShapeWithOptionalTypes::class, 'expectedResult' => '{"stringBased":"Some value","stringOrNull":"some string","givenNamesOrNull":["Jane","John"],"optionalStringBased":"oSB value","optionalInt":55,"optionalBool":false,"boolWithDefault":true}'];
        yield 'from array with null-values for optionals' => ['value' => ['stringBased' => 'Some value', 'stringOrNull' => null, 'givenNamesOrNull' => null, 'optionalBool' => null], 'className' => Fixture\ShapeWithOptionalTypes::class, 'expectedResult' => '{"stringBased":"Some value","stringOrNull":null,"givenNamesOrNull":null}'];
